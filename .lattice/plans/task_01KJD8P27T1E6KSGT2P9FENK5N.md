...
3. Prevent full-scene whiteout at long zoom distances by making atmospheric fog range aware of camera distance.
4. Keep a world-bounds fallback when land data has not loaded yet, and re-check behavior with lint/typecheck for regressions.
